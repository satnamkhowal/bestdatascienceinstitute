...
<?php if($slug==='data-science-course-jaipur'): ?>
<section class="bdsi-section"><div class="container"><div class="bdsi-content-card"><span class="bdsi-kicker">Related Jaipur Resource</span><h2 class="mt-2">Compare another Data Science course structure</h2><p class="mb-0">Students researching practical Data Science training can also review the <a href="https://jaipurengineers.com/data-science-course-jaipur.php" target="_blank" rel="noopener">Data Science Course at Jaipur Engineers</a> and compare current curriculum, projects and learning mode directly.</p></div></div></section>
<?php endif; ?>
<?php if($slug==='full-stack-development-course-jaipur'): ?>
<section class="bdsi-section"><div class="container"><div class="bdsi-content-card"><span class="bdsi-kicker">Related Jaipur Resource</span><h2 class="mt-2">Compare another Full Stack learning path</h2><p class="mb-0">For another practical Full Stack curriculum in Jaipur, students can review the <a href="https://forskcodingschool.com/full-stack-development-course-jaipur.php" target="_blank" rel="noopener">Full Stack Development Course at Forsk Coding School</a> and verify current batch details directly.</p></div></div></section>
<?php endif; ?>
