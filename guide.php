...
$structuredData=[
  [
    ...
    'mainEntityOfPage'=>$canonical,'datePublished'=>'2026-09-15','dateModified'=>'2026-09-15',
...
<section class="bdsi-section"><div class="container"><div class="row g-5">
  ...
  <aside class="col-lg-4"><div class="bdsi-content-card position-sticky" style="top:110px"><span class="bdsi-kicker">Related Guides</span><h3 class="mt-2">Keep Learning</h3><?php foreach(array_slice($related,0,3,true) as $rSlug=>$r): ?><p class="mb-3"><a href="<?=htmlspecialchars($rSlug)?>.php"><?=htmlspecialchars($r['title'])?></a></p><?php endforeach; ?><hr class="border-secondary"><a href="blog.php">Browse all resources →</a></div></aside>
</div></div></section>
</main>
